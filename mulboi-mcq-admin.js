...
const MB_EXP_BOX_RULE = (
    ...
    `থেকে এই প্রশ্নটি বানানো হয়েছে। এটা সবচেয়ে গুরুত্বপূর্ণ নিয়ম: যে টপিক/উদ্দীপক/paragraph থেকে প্রশ্ন এসেছে সেই সম্পূর্ণ ` +
    `অংশটা (heading/title সহ যদি থাকে) নিখুঁতভাবে শুরু থেকে শেষ পর্যন্ত y,h এর মধ্যে থাকতে হবে — এই মূল টপিক অংশের ` +
    `কোনো লাইন/বাক্য কখনোই মাঝপথে কাটা যাবে না বা বাদ পড়বে না। শুধু প্রশ্ন সম্পর্কিত এক-দুই লাইন দিলে চলবে না, ` +
    `পুরো টপিকটাই থাকতে হবে যাতে একজন শিক্ষার্থী সম্পূর্ণ প্রসঙ্গ পড়তে পারে। ` +
    `উপরে টপিক শুরুর ঠিক আগ থেকে এবং নিচে টপিক শেষ হওয়ার ঠিক পর থেকে অতিরিক্ত ২-৩ লাইন বাফার (buffer) যোগ করবে — ` +
    `এই বাফার-জোনে (মূল টপিকের ঠিক উপরে/নিচে) যদি আগের/পরের অন্য প্যারার অংশ আংশিকভাবে (partial/cut) চলে আসে সেটা সমস্যা না, ` +
    `কিন্তু মূল টপিক অংশ কখনোই আংশিক/partial হবে না — সেটা সবসময় সম্পূর্ণ থাকবে। ` +
...
async function mbCropExplanationImage(pageNum, box) {
    ...
    try {
        ...
        const padPct = 6; // উপরে-নিচে অতিরিক্ত ৬% বাফার, টপিক কাটা পড়া এড়াতে (আগে ৪% ছিল)
        let py, ph;
        if (validBox) {
